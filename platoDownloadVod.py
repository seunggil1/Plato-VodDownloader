...
if __name__ == '__main__':
    ...
    tkinter.Tk().withdraw()
    webdriverLocation = tkinter.filedialog.askopenfile(filetypes =[('Edgewebdriver', '*.exe')])
...
#    options.add_argument('disable-gpu')
    ...
    test = driver.find_elements_by_class_name("course-title")
